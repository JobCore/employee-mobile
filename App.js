...
const MainDrawerNavigator = createDrawerNavigator({
  ...
  [REGION_GRAN_CARACAS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_CENTRO_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_GUAYANA_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_LOS_ANDES_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_LOS_LLANOS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_OCCIDENTE_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [REGION_ORIENTE_ROUTE]: { screen: props => <SideBarRoute {...props} /> },

  [SECTION_SUCESOS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_POLITICA_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_ECONOMIA_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_DEPORTES_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_TECNOLOGIA_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_INTERNACIONAL_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_REPORTAJES_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_SALUD_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_OPINION_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_MIGRACION_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [SECTION_MAS_NOTICIAS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },

  [RESTFUL_INVESTIGACIONES_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [RESTFUL_EL_PITAZO_EN_LA_CALLE_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [RESTFUL_ALIANZAS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },

  [MEDIA_FOTOGALERIAS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [MEDIA_VIDEOS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
  [MEDIA_INFOGRAFIAS_ROUTE]: { screen: props => <SideBarRoute {...props} /> },

  [RADIO_ROUTE]: { screen: props => <SideBarRoute {...props} /> },
