...
export const INVITE_DETAILS_NEW_ROUTE = 'INVITE_DETAILS_NEW_ROUTE';
...
export const JOB_DETAILS_NEW_ROUTE = 'JOB_DETAILS_NEW_ROUTE';
...
export const JOB_PENDING_PAYMENTS_ROUTE = 'JOB_PENDING_PAYMENTS_ROUTE';
export const JOB_WORK_MODE_ROUTE = 'JOB_WORK_MODE_ROUTE';
